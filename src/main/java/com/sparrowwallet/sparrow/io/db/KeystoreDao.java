...
public interface KeystoreDao {
    @SqlQuery("select keystore.id, keystore.label, keystore.source, keystore.walletModel, keystore.masterFingerprint, keystore.derivationPath, keystore.extendedPublicKey, keystore.externalPaymentCode, keystore.silentPaymentScanAddress, keystore.deviceRegistration, keystore.antiExfilPolicy, " +
    ...
    @SqlUpdate("insert into keystore (label, source, walletModel, masterFingerprint, derivationPath, extendedPublicKey, externalPaymentCode, silentPaymentScanAddress, deviceRegistration, antiExfilPolicy, masterPrivateExtendedKey, seed, wallet, index) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
    @GetGeneratedKeys("id")
    long insert(String label, int source, int walletModel, String masterFingerprint, String derivationPath, String extendedPublicKey, String externalPaymentCode, byte[] silentPaymentScanAddress, byte[] deviceRegistration, int antiExfilPolicy, Long masterPrivateExtendedKey, Long seed, long wallet, int index);
    ...
    @SqlUpdate("update keystore set antiExfilPolicy = ? where id = ?")
    void updateAntiExfilPolicy(int antiExfilPolicy, long id);
